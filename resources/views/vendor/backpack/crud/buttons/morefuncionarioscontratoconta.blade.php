<div class="btn-group">
    ...
    <ul class="dropdown-menu dropdown-menu-right">
        ...
        <li><a href="/gescon/contrato/contratoconta/contratoterceirizado/{{$entry->getKey()}}/retiradacontratoconta/create">&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i>Nova liberação para este empregado</a></li>
