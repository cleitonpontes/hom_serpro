...
@php
    ...
    $connected_entity_unidade = new App\Models\Unidade();
    $connected_entity_codigo_item = new App\Models\Codigoitem();
            ...
            @foreach ($old_value as $item)
                @if (!is_object($item))
                    @php
                        ...
                        $unidade = $connected_entity_unidade->find($item->unidade_id);
                        $codigo_item = $connected_entity_codigo_item->find($item->compra->modalidade_id);
                    @endphp
                @endif
