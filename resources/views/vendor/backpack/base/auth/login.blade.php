                ...
                <div class="box-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST"
                        ...
                        <div class="text-center m-t-20">
                            <label>
                                <p>Você pode utilizar autenticação via Acesso Gov.</p>
                            </label>
                            <br>
                            <div>
                                <a href="{{ url('/acessogov/autorizacao') }}" class="btn btn-success" id="prev_aba"><span class="fa fa-sign-in"></span> &nbsp;Entrar com Acesso Gov</a>
                            </div>
                            <br>
