...
class DiarioOficialController extends BaseSoapController
{
    ...
    public function montaOficioPreview(Contrato $contrato)
    {
        ...
        $dados ['dados']['identificadorTipoPagamento'] = 89; //ISENTO -> ConsultaFormasPagamento //89 - empenho
...
//        dd($dados);
    ...
    public function retornaTextoRtf(string $texto)
    {
        ...
        dump($texto1);
        $texto2 = "{\\rtf1\ansi\deff0{\\fonttbl{\\f0 Times New Roman;}}";
//        {\b Hello {\pard gentle } world !}";
//        {\pard\sa200\sl276\slmult1\qc\b\\f0\\fs22\lang22 \b testse \par}";
        dump($texto2);
        return $texto2;
    }
