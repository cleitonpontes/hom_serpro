...
//            $orgao = Orgao::where('codigo', request()->input('orgao'))
//                ->first();
//        }
//
//        if (request()->input('orgao') and !isset($orgao->codigo)) {
//            \Alert::warning('Esse Órgão não Existe em nossa Base!')->flash();
//        }
...
//        $this->crud->removeAllButtonsFromStack('line');
        ...
        */
        ...
        $unidades = Unidade::select(DB::raw("CONCAT(codigo,' - ',nome) AS nome"), 'codigo')
